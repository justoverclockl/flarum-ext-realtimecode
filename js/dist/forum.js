...
/***/ "./src/forum/components/RealTimeEditor.js":
/*!************************************************!*\
  !*** ./src/forum/components/RealTimeEditor.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RealTimeEditor; });
...
var RealTimeEditor = /*#__PURE__*/function (_Page) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(RealTimeEditor, _Page);
  ...
  _proto.view = function view() {
    return m('.IndexPage', [flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_2___default.a.prototype.hero(), m('.container', m('.sideNavContainer', [m('nav.IndexPage-nav.sideNav', m('ul', flarum_helpers_listItems__WEBPACK_IMPORTED_MODULE_3___default()(flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_2___default.a.prototype.sidebarItems().toArray()))), m('.IndexPage-results.sideNavOffset', [m('div', {
      ...
      className: 'maintitle'
    }, app.translator.trans('flarum-ext-realtimecode.forum.htmleditor'))), m('div', {
      className: 'mainpar'
    }, m('p', {
      className: 'desc'
    }, app.translator.trans('flarum-ext-realtimecode.forum.description'))), m('div', {
      className: 'main'
    }, [m('textarea', {
      className: 'contedit',
      id: 'editortext',
      ...
      oncreate: function oncreate(_ref) {
        var dom = _ref.dom;
        return codemirror__WEBPACK_IMPORTED_MODULE_4___default.a.fromTextArea(dom, {
          lineNumbers: true,
          lineWrapping: true,
          mode: "text/html",
          matchBrackets: true,
      ...
      className: 'outptitle'
    }, app.translator.trans('flarum-ext-realtimecode.forum.outputtitle'))), m('iframe', {
      id: 'output'
    })])])]))]);
  };
...
/* harmony import */ var _components_RealTimeEditor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/RealTimeEditor */ "./src/forum/components/RealTimeEditor.js");
...
flarum_app__WEBPACK_IMPORTED_MODULE_4___default.a.initializers.add('justoverclock/flarum-ext-realtimecode', function () {});
flarum_app__WEBPACK_IMPORTED_MODULE_4___default.a.routes.RealTimeEditor = {
  path: '/editor',
  component: _components_RealTimeEditor__WEBPACK_IMPORTED_MODULE_3__["default"]
};
Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'navItems', function (navItems) {
  navItems.add('RealTimeEditor', m(flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_2___default.a, {
    href: flarum_app__WEBPACK_IMPORTED_MODULE_4___default.a.route('RealTimeEditor'),
    icon: "fas fa-laptop-code"
  }, flarum_app__WEBPACK_IMPORTED_MODULE_4___default.a.translator.trans('flarum-ext-realtimecode.forum.title')), 100);
  return navItems;
});
